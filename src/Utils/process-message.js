...
const cleanMessage = (message, meId, meLid) => {
    ...
    if ((0, WABinary_1.isHostedPnUser)(message.key.remoteJid) || (0, WABinary_1.isHostedLidUser)(message.key.remoteJid)) {
        message.key.remoteJid = (0, WABinary_1.jidEncode)((_b = (0, WABinary_1.jidDecode)((_a = message.key) === null || _a === void 0 ? void 0 : _a.remoteJid)) === null || _b === void 0 ? void 0 : _b.user, (0, WABinary_1.isHostedPnUser)(message.key.remoteJid) ? 's.whatsapp.net' : 'lid');
    }
    else {
    ...
    if ((0, WABinary_1.isHostedPnUser)(message.key.participant) || (0, WABinary_1.isHostedLidUser)(message.key.participant)) {
        message.key.participant = (0, WABinary_1.jidEncode)((_c = (0, WABinary_1.jidDecode)(message.key.participant)) === null || _c === void 0 ? void 0 : _c.user, (0, WABinary_1.isHostedPnUser)(message.key.participant) ? 's.whatsapp.net' : 'lid');
    }
    else {
    ...
    if (protocolMsg) {
        ...
        const emitGroupUpdate = (update) => {
            ...
            ev.emit('groups.update', [
                { id: jid, ...update, author: (_a = message.key.participant) !== null && _a !== void 0 ? _a : undefined, authorPn: message.key.participantAlt }
            ]);
        };
