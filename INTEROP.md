...
phoenix-baileys-v2 supports the WhatsApp Interoperability Protocol (DMA-Interop), which allows users of third-party messaging services to communicate with WhatsApp accounts.
