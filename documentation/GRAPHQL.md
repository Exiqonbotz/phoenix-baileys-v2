...
phoenix-baileys-v2 also supports WhatsApp's three HTTPS GraphQL schemas, which power features like Meta AI, Imagine, Events, payments, and business tools. Unlike MEX (which runs over WebSocket), these go out over HTTPS POST requests.
...
HTTPS GraphQL requires an **ACS access token**. phoenix-baileys-v2 fetches this automatically:
