...
phoenix-baileys-v2 implements the full WhatsApp username protocol, reverse-engineered from WhatsApp 2.26.17.2 (Java decompilation of `C1568872p.java`, `C164057Wg.java`, `MexUsernamePinProtocolApi.java`) and updated with live traffic captured from WA 2.26.26.4 using `wa-logger-2.26.26.4.js`.
