...
phoenix-baileys-v2 exposes all MEX operations as socket methods. MEX is WhatsApp's internal GraphQL system that runs over the existing WebSocket connection, with no extra HTTP requests and no authentication tokens beyond your normal session.
